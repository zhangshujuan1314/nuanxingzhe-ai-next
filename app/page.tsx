    ...
    <div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-6 pt-20 pb-16 text-center relative z-10">
          ...
          <p className="text-[#5C5C5C] text-lg max-w-3xl mx-auto mb-4 leading-relaxed">
            全国 2000 万即时配送骑手，约 1600 万运力消耗在找楼栋、等电梯、绕远路这些「无效空耗」上——每单平均多花 5 分钟。
          </p>
          <p className="text-[#5C5C5C] max-w-3xl mx-auto leading-relaxed">
          ...
          <div className="flex flex-wrap justify-center gap-6 mt-12">
            <div className="card w-48 text-center">
              ...
              <div className="text-[#8E8E8E] text-sm mt-1">即时配送骑手</div>
            </div>
            <div className="card w-48 text-center">
              <div className="text-3xl font-bold text-warm"><CountUp target={1600} />万</div>
              <div className="text-[#8E8E8E] text-sm mt-1">运力无效空耗</div>
            </div>
            <div className="card w-48 text-center">
              <div className="text-3xl font-bold text-warm"><CountUp target={5} />分钟/单</div>
              <div className="text-[#8E8E8E] text-sm mt-1">平均绕路时间</div>
            </div>
          </div>
      ...
      <section className="max-w-4xl mx-auto px-6 py-12">
        <div className="glass p-8 relative">
          ...
          <p className="text-[#5C5C5C] text-lg leading-relaxed italic pl-8">"{userStory}"</p>
          <p className="text-[#8E8E8E] text-sm mt-3 pl-8">— 阳光花园社区居民 王女士</p>
        </div>
      </section>
      ...
      <section className="max-w-5xl mx-auto px-6 py-8">
        ...
        <p className="text-[#8E8E8E] text-center mb-8">从新手到社区信赖，每一步都有暖行者相伴</p>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {levels.map(l => (
            <div key={l.lv} className="card flex flex-col items-center text-center p-6">
              ...
              <p className="text-[#5C5C5C] text-sm mb-3">{l.desc}</p>
              <span className="text-[#8E8E8E] text-xs bg-[#E8E5E1]/30 px-3 py-1 rounded-full">{l.requirement}</span>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="max-w-4xl mx-auto px-6 py-8">
        ...
        <p className="text-[#8E8E8E] text-center mb-8">全面衡量骑手贡献，让信任看得见</p>
        <div className="space-y-5">
          {scoreDimensions.map(d => (
            <div key={d.name} className="card">
              <div className="flex items-center justify-between mb-2">
                <span className="font-medium">{d.name} <span className="text-[#8E8E8E] text-xs">({d.pct}%)</span></span>
              ...
              <p className="text-[#8E8E8E] text-xs">{d.items}</p>
            </div>
          ))}
        </div>
